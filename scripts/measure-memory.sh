...
# measure-memory.sh — sample RSS for a process by PID or PM2 app name
# Usage:
#   scripts/measure-memory.sh --pid <PID> [--duration 10] [--interval 0.2]
#   scripts/measure-memory.sh --pm2 <APP_NAME> [--duration 10] [--interval 0.2]
#
