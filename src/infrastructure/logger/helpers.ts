...
// findProjectRoot is exported from FileStorageService for centralization
...
/**
 * * EXPERIMENTAL * * doesn't require by assessment task. In some cases it can be useful.
 *
 ...
 * - On each write operation, it overwrites the final `]` with `,(optional)\n<chunk>\n]`
 *   depending on whether the array already contains elements.
 */
