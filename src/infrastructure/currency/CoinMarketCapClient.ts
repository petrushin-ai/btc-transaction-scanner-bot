import { fetchJson, HTTP_METHOD, JSON_HEADERS } from "@/app/helpers/http";
import { isCryptoCurrencyCode, isFiatCurrencyCode } from "@/types/currency";
...
// Use shared guards to keep a single source of truth
const isCrypto = (code: string): boolean => isCryptoCurrencyCode( code );
const isFiat = (code: string): boolean => isFiatCurrencyCode( code );
