...
Docker/Compose and full instructions are in `docs/README_FULL.md`.
...
Details: `docs/ARCHITECTURAL_RUNBOOK.md` (sequence + services), `docs/EVENTS.md` (versioned domain events and JSON samples).
...
See `docs/EVENTS.md` for domain event schemas with `dedupeKey`/`eventId` idempotency.
...
- Raw parser design: `docs/BTC_RAW_PARSER.md`
